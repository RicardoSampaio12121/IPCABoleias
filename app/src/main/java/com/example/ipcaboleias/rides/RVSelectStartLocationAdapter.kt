...
class RVSelectStartLocationAdapter(var stops: MutableList<NewStop>, var startPosition: LatLng): RecyclerView.Adapter<RVSelectStartLocationAdapter.ToDoViewHolder>() {
    ...
    inner class ToDoViewHolder(
        ...
        listener: RVSelectStartLocationAdapter.onItemClickListener
